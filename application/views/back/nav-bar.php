...
<!-- 
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Links <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                <li><a href="<?php echo base_url() ?>user/links">Links</a>
                                                </li>
                                                <li><a href="<?php echo base_url() ?>user/add">add Links</a>
                                                </li>
...
<script type="text/javascript">
        let base_urlX = "<?php echo base_url() ?>";

    $.ajax({
        url:base_urlX + "user/earnings/get_balance",
