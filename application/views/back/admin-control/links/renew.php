...
<!-- 
 ...
 -->
                                            ...
                                            <a type="submit" href="<?php echo base_url() ?>admin/links/delete/<?php echo $link->id ?>" class="btn btn-danger mt-3 mb-3 float-left ">delete</a>
                                                            ...
                                                            <?php if($link->status=="published"&&$link->clicks<=0): ?>  
                                                               ...
                                                               <div class="form-group">
                                                                <?php if($link->status!=="draft"): ?>
                                                                    ...
                                                                    <select id="clicks" class="form-control" name="clicks">
