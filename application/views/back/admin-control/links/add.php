       <!-- Single pro tab review Start-->
        <div class="single-pro-review-area mt-t-30 mg-b-15" style="margin-top: 30px;">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    ...
                                                    <form action="<?php echo base_url(); ?>admin/links/APIaddAdmin" class="dropzone dropzone-custom needsclick addlibrary" id="demo1-upload" method="POST">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                 <label>Clicks</label>
                                                                    ...
                                                                    <select class="form-control" name="clicks">
