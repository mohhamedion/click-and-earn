		...
		<nav class="navbar navbar-default navbar-fixed-top templatemo-nav" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="#" class="navbar-brand">Click And Win</a>
				</div>
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right text-uppercase">
						<li><a href="<?php echo base_URL() ?>welcome/login">log in</a></li>
						<li><a href="<?php echo base_url() ?>welcome/register">sing up</a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-10 wow fadeIn" data-wow-delay="0.3s">
							<h1 class="text-upper">Click and Earn</h1>

    
                   

							<p class="tm-white h3">0.002 per click on the link 
        There are more than 1000 links per day  </p>
...
<div class="col-md-6 wow  fadeInLeft" data-wow-delay="0.6s">
						<img src="<?php echo  base_url(); ?>assets/front/images/software-img.png" class="img-responsive" alt="feature img">
					</div>

					<div class="col-md-6 wow fadeInRight" data-wow-delay="0.6s">
						<h2 class="text-uppercase site-color">Earn 0.002</h2>
						<p class="font-20"><i class="fa fa-dollar site-color" ></i>  on each click you earn 0.002. </p>
 					</div>
...
<!-- 						<img src="images/software-img.png" class="img-responsive" alt="feature img">
 -->					
 	 <p><i class="fa fa-link" style="font-size: 100px;
    padding-top: 83px;
    width: 200px;
    height: 200px;
    margin-left-right: 42px;
    "></i></p>
					</div>
					<div class="col-md-6 wow fadeInUp" data-wow-delay="0.6s">
						<h2 class="text-uppercase site-color">  Referral program </h2>
						<p>The site given each active referral (exceeded 100 click ) 0.20$</p>
						<p class="font-20"><span><i class="fa fa-share"></i></span>Share our site and take your money</p>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 wow fadeInUp templatemo-box" data-wow-delay="0.3s">
						...
						<h3 class="text-uppercase">Users earning money</h3>
						<p class="h2">8000</p>
					</div>
					<div class="col-md-4 wow fadeInUp templatemo-box" data-wow-delay="0.3s">
						<i class="fa fa-link"></i>
						<h3 class="text-uppercase">Number of shared links</h3>
						<p class="h2" >10000</p>
					</div>
					<div class="col-md-4 wow fadeInUp templatemo-box" data-wow-delay="0.3s">
						<i class="fa fa-dollar"></i>
						<h3 class="text-uppercase">money given</h3>
						<p class="h2">20$</p>
					</div>
				</div>
			</div>
...
<!-- start divider -->
		<section id="pricing">
			<div class="container">
				<div class="row">
					<h2 class="bold   site-color" >Payments Methods</h2>
					...
					<div class="col-md-6 wow fadeInUp templatemo-box" data-wow-delay="0.3s">
						...
						<img src="https://www.3allemni.com/wp-content/uploads/2018/10/1200px-Skrill_logo.svg_.png">
		...
		<script src="<?php echo  base_url(); ?>assets/front/js/jquery.singlePageNav.min.js"></script>
